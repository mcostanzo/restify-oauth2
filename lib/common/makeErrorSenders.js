...
module.exports = function makeErrorSenders(grantTypes) {
    ...
    return {
        ...
        tokenRequired: function (res, next, options, message) {
            ...
            sendWithHeaders(res, next, options, new restifyErrors.BadRequestError(message));
        },
        ...
        authenticationRequired: function (res, next, options, message) {
            ...
            sendAuthenticationRequired(res, next, options, new restifyErrors.UnauthorizedError(message));
        },
        ...
        insufficientAuthorization: function (res, next, options, message) {
            ...
            sendInsufficientAuthorization(res, next, options, new restifyErrors.ForbiddenError(message));
        },
        ...
        tokenInvalid: function (res, next, options, message) {
            ...
            sendWithHeaders(res, next, options, new restifyErrors.UnauthorizedError(message));
        }
    };
};
